/* plugins потрібні для роботи sly
------------------------------------------------------- */
...
(function() {
    ...
    Plugin.prototype.structure = function() {
        ...
        if (this.s.controls && this.$items.length > 1) {
            controls = '<div class="modal-gallery-nav">' +
                '<button type="button" aria-label="Previous slide" class="lg-prev">' + this.s.prevHtml + '</button>' +
                '<button type="button" aria-label="Next slide" class="lg-next">' + this.s.nextHtml + '</button>' +
                '</div>';
        }
        ...
        template = '<div tabindex="-1" aria-modal="true" ' + ariaLabelledby + ' ' + ariaDescribedby + ' role="dialog" class="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' +
            ...
            '<div class="lg-inner">' + list + '</div>' +
				...
				'<a href="#" class="lg-close">'+
					'<svg class="lg-close-icon" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">'+
						'<path d="M1 1L41 41M41 1L1 41" stroke-width="2"></path>' +
					'</svg>'+
				'</a>'+
				'<div class="modal-gallery-toolbar">'+
					'<div class="lg-thumb-outer">'+
						...
						'</div>'+
					'</div>'+
					'<div class="modal-gallery-toolbar-right">'+
						controls +
					'</div>'+
				'</div>'+
            '</div>' +
        ...
        this.$outer = $('.lg-outer');
		this.$outer.addClass('slideInDown');
        this.$outer.focus();
    ...
    Plugin.prototype.counter = function() {
        if (this.s.counter) {
            $(this.s.appendCounterTo).prepend('<div id="lg-counter" role="status" aria-live="polite"><span id="lg-counter-current">' + (parseInt(this.index, 10) + 1) + '</span> / <span id="lg-counter-all">' + this.$items.length + '</span></div>');
        }
    };
    ...
    */
    ...
    Plugin.prototype.destroy = function(d) {
        ...
        if (_this.$outer) {
			...
			_this.$outer.removeClass('slideInDown').addClass('slideOutUp');
        }
